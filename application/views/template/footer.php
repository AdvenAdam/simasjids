<footer class="footer">
	<div class="container-fluid">
		...
		<div class="copyright ml-auto">
			<i class="fa fa-user text-primary"></i> <a href="">APP SIMASJID 2020</a>
		</div>				
	</div>
</footer>
</div>
...
<!-- JQuery Mask -->
<script src="<?= site_url('assets/assets/') ;?>js/plugin/jquery-Mask-Plugin-master/jquery.mask.js"></script>
